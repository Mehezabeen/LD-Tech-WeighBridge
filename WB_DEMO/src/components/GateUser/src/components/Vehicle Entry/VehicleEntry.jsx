...
const VehicleEntry = ({ onConfirmTicket = () => { } }) => {
  ...
  return (
    <div className={`vehicleEntry-main ${isSidebarExpanded ? 'sidebar-expanded' : ''}`}>
      ...
      <div className="container" >
        ...
        <div className="vehicle-table-container mx-auto px-4 py-8" style={{ marginLeft: 'auto', overflowX: 'auto' }}> {/* Add overflowX style for horizontal scrollbar */}
